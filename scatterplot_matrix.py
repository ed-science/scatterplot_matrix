...
for var1count, var1 in enumerate(variables):
    for var2count, var2 in enumerate(variables):
        ...
        elif var1count>var2count: ## lower triangle, colorcode by second variable ####################
        ...
        else:  ## upper triangle, colorcode by first variable ####################
